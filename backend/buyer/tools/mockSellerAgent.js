...
//      these two endpoints, it drops in with no changes to Ampy.
//
// Point Ampy at it and run:
//
...
app.listen(PORT, () => {
  ...
  console.log(`[mock-seller] point Ampy at it: SELLER_AGENT_URL=http://localhost:${PORT} npm start`);
});
