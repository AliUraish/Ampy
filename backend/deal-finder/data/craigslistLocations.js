...
// slug / display name), used to populate the `location` dropdown in the
// buyer portal instead of a free-text field. A mistyped or non-existent
// location (e.g. "San Franscico") 404s against Craigslist's search
// endpoint and silently falls back to mock data — this list is the fix:
// every value the UI can send is a slug Craigslist actually recognizes.
//
